...
namespace Roblox.Configuration
{
    public class Provider : SettingsProvider
    {
        ...
        public override SettingsPropertyValueCollection GetPropertyValues(SettingsContext context, SettingsPropertyCollection collection)
        {
            ...
            {
                var setting = obj as SettingsProperty;
            ...
            using (var db = new ConfigurationDataClassesDataContext(connectionString))
            {
                ...
                foreach (var setting in settingQuery)
                {
                    ...
                    if (!properties.TryGetValue(setting.Name, out value))
        ...
        public override void SetPropertyValues(SettingsContext context, SettingsPropertyValueCollection collection)
        {
            ...
            using (var db = new ConfigurationDataClassesDataContext(connectionString))
            {
                foreach (var obj in collection)
                {
                    var value = obj as SettingsPropertyValue;
        ...
        {
            var provider = e.Provider as Provider;
            if (provider != null && provider.applicationSettings != applicationSettings)
            {
